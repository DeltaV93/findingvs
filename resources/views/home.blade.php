...
<div class="colums row align-center inside">
    <img class="float-center large-12 main-logo" src="img/deltav_white.svg">
</div>
<div class="row align-center">
  <h1 class="text-center">Valerie Sharp</h1>
</div>
<div class="row align-center">
  <h3>Frontend Devloper / UX Designer</h3>
  {{-- <h3 class="text-center ">Creater of Delta<span class="deltav-v">V</span> Industry</h3> --}}
</div>
<div class="row align-center text-center">
  <a class="direct-contact" href="mailto:valerie.n.sharp93@gmail.com"></a>
